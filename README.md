...
Please note: <br>
    This script utilizes the [single-cell-curation](https://github.com/chanzuckerberg/single-cell-curation/tree/main) repo which should be cloned to the following directory: `~/GitClones/CZI/` <br>
    CXG API keys should also be stored in `~/Documents/keys/cxg-api-key.txt`
