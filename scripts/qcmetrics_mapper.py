	...
	"star": {
		"rna": {
			"schema_mapping": {
				...
				"fraction_of_reads_in_cells": "frac_reads_in_cells",
				...
				"reads_mapped_to_transcriptome:_unique_genefulls": "frac_reads_mapped_confidently_to_transcriptome",
