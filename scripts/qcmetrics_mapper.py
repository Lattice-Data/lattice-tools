cellranger= {
	...
	"atac": {
	    "schema_mapping": {
			...
			"fraction_of_high-quality_fragments_in_cells": "frac_high-quality_fragments_in_cells",
			"fraction_of_high-quality_fragments_overlapping_peaks": "frac_high-quality_fragments_overlapping_peaks",
			"fraction_of_high-quality_fragments_overlapping_tss": "frac_high-quality_fragments_overlapping_tss",
