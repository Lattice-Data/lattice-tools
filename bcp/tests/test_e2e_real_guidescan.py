...
class TestGuidescanAvailability:
    ...
    def test_guidescan_executable_exists(self):
        ...
        result = subprocess.run(["guidescan", "--help"], capture_output=True)
    ...
    def test_guidescan_enumerate_command_exists(self):
        ...
        result = subprocess.run(
            ["guidescan", "enumerate", "--help"], capture_output=True
        )
        assert result.returncode == 0
...
class TestDirectGuidescanExecution:
    ...
    def test_direct_guidescan_command(
        self, toy_genome_index, test_guides_file, temp_dir
    ):
    ...
    def test_guidescan_output_format(
        self, toy_genome_index, test_guides_file, temp_dir
    ):
...
class TestFullPipelineWithRealGuidescan:
    ...
    def test_pipeline_output_properties(
        self, toy_genome_index, test_guides_file, temp_dir
    ):
...
class TestE2EEdgeCases:
    ...
    def test_guides_with_matches_and_no_matches(
        self, toy_genome_index, test_guides_file, temp_dir
    ):
