...
# Layer 2. Four slots, because a project name is written four ways and only the
# first was covered at first: ``smith-seahub-bcp/REF3/raw/...`` passed both layers
# while ``labalpha-mapping-grns-perturb-seq`` was not even in the allowlist,
