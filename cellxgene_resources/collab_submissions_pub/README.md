...
- **Figure 2**
    - **Figure 2a:** Cumulative counts of Collections (submissions) and unique cells released in CELLxGENE
    - **Figure 2b:** Cumulative number of preprints and publications citing CELLxGENE
- **Contributor statistics:** Various metrics cited throughout the manuscript, including:
  - Contributor return rates
  - Data release timing relative to publication dates
...
## Acknowledgments
This work has been made possible by Biohub through grants from the Chan Zuckerberg Initiative Foundation.
