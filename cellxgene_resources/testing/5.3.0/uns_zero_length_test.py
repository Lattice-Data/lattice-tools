...
https://github.com/chanzuckerberg/single-cell-curation/issues/753
https://github.com/chanzuckerberg/single-cell-curation/issues/822

Reusing from 5.0.0 to test for 5.0.1 patch with issue 822 above
"""
...
class TestUnsZeroLength:
    ...
    def test_uns_zero_length_passes(self, validator_with_adatas, uns_key, empty_value, expected):
    ...
    def test_uns_zero_length_fails(self, validator_with_adatas, uns_key, empty_value, expected):
        validator = validator_with_adatas
        validator.adata.uns[uns_key] = empty_value
        validator.validate_adata()
        assert validator.is_valid is expected
    ...
    def test_uns_zero_length_fails_many_errors(self, validator_with_adatas, uns_key, empty_value, expected):
        validator = validator_with_adatas
        validator.adata.uns[uns_key] = empty_value
        validator.validate_adata()
        assert validator.is_valid is expected
    ...
    def test_uns_title_bool_none_fails(self, validator_with_adatas, bool_value, expected):
        validator = validator_with_adatas
