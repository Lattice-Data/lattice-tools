...
@pytest.mark.parametrize(
    "duplicate_col",
    (
        pytest.param('gene_symbol', id="duplicated raw var 'gene_symbol'"),
        pytest.param('ensembl_version', id="duplicated raw var 'ensembl_version'"),
    )
)
def test_raw_var_concat_fails(duplicate_col):
