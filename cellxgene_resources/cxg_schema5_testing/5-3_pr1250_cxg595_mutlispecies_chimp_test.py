...
def test_feature_ids(validator_with_chimp_adata,ensembl_prefix_term):
...
def test_ncbi_term(validator_with_chimp_adata,organism_term):
    validator = validator_with_chimp_adata
...
def test_orthologs(validator_with_chimp_adata,organism_term):
    validator = validator_with_chimp_adata
    validator.adata.obs["organism_ontology_term_id"] = organism_term
    validator.validate_adata()
    assert validator.is_valid
...
def test_chimp_ncbi_term_in_mouse_dev_stage(validator_mouse_adata):
...
def test_chimp_ncbi_term_in_worm_tissue(validator_with_worm_adata):
...
def test_chimp_ncbi_term_in_worm_cl(validator_with_worm_adata):
    validator = validator_with_worm_adata
    validator.adata.obs["organism_ontology_term_id"] = "NCBITaxon:9598"
    validator.validate_adata()
    assert not validator.is_valid
...
def test_chimp_ncbi_term_in_worm_dev(validator_with_worm_adata):
    validator = validator_with_worm_adata
    validator.adata.obs["organism_ontology_term_id"] = "NCBITaxon:9598"
    validator.validate_adata()
    assert not validator.is_valid
...
def test_chimp_ncbi_term_in_fly_tissue(validator_with_fly_adata):
...
def test_chimp_ncbi_term_in_fly_cl(validator_with_fly_adata):
    validator = validator_with_fly_adata
    validator.adata.obs["organism_ontology_term_id"] = "NCBITaxon:9598"
    validator.validate_adata()
    assert not validator.is_valid
...
def test_chimp_ncbi_term_in_fly_dev(validator_with_fly_adata):
    validator = validator_with_fly_adata
    validator.adata.obs["organism_ontology_term_id"] = "NCBITaxon:9598"
    validator.validate_adata()
    assert not validator.is_valid
...
def test_chimp_ncbi_term_in_fish_tissue(validator_with_zebrafish_adata):
...
def test_chimp_ncbi_term_in_fish_cl(validator_with_zebrafish_adata):
    validator = validator_with_zebrafish_adata
    validator.adata.obs["organism_ontology_term_id"] = "NCBITaxon:9598"
    validator.validate_adata()
    assert not validator.is_valid
...
def test_chimp_ncbi_term_in_fish_dev(validator_with_zebrafish_adata):
    validator = validator_with_zebrafish_adata
    validator.adata.obs["organism_ontology_term_id"] = "NCBITaxon:9598"
    validator.validate_adata()
    assert not validator.is_valid
