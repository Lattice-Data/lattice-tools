...
# fixtures are valid
def test_all_valid(validator_with_multispecies_adatas):
...
def test_cl_forbidden_zebrafish(validator_with_zebrafish_adata, cell_type_term, error_suffix):
...
def test_non_cl_forbidden_for_zebrafish(validator_with_zebrafish_adata, cell_type_term):
    validator = validator_with_zebrafish_adata
    validator.adata.obs["cell_type_ontology_term_id"] = cell_type_term 
    validator.validate_adata()
    assert not validator.is_valid
...
def test_cl_in_tissue_term_for_cell_culture(validator_with_zebrafish_adata, cell_type_term):
    validator = validator_with_zebrafish_adata
...
def test_cl_forbidden_cell_culture(validator_with_zebrafish_adata, cell_type_term, error_variable):
    validator = validator_with_zebrafish_adata
    validator.adata.obs["tissue_type"] = "cell culture"
    validator.adata.obs["tissue_ontology_term_id"] = cell_type_term 
    validator.validate_adata()
...
def test_non_cl_forbidden_for_zebrafish_cell_culture(validator_with_zebrafish_adata, cell_type_term):
    validator = validator_with_zebrafish_adata
    validator.adata.obs["tissue_type"] = "cell culture"
    validator.adata.obs["tissue_ontology_term_id"] = cell_type_term 
    validator.validate_adata()
...
def test_dev_terms_for_zebrafish(validator_with_zebrafish_adata, dev_term, error_variable):
    validator = validator_with_zebrafish_adata
...
def test_tissue_terms_zebrafish(validator_with_zebrafish_adata, tissue_term, error_variable):
    validator = validator_with_zebrafish_adata
