...
def test_cl_forbidden_worm(validator_with_worm_adata, cell_type_term, error_suffix):
...
def test_non_cl_forbidden_for_worm(validator_with_worm_adata, cell_type_term):
    validator = validator_with_worm_adata
    validator.adata.obs["cell_type_ontology_term_id"] = cell_type_term 
    validator.validate_adata()
    assert not validator.is_valid
...
def test_cl_in_tissue_term_for_cell_culture(validator_with_worm_adata, cell_type_term):
    validator = validator_with_worm_adata
...
def test_non_cl_forbidden_for_worm_cell_culture(validator_with_worm_adata, cell_type_term):
    validator = validator_with_worm_adata
    validator.adata.obs["tissue_type"] = "cell culture"
    validator.adata.obs["tissue_ontology_term_id"] = cell_type_term 
    validator.validate_adata()
...
def test_dev_terms_for_worm(validator_with_worm_adata, dev_term, error_variable):
    validator = validator_with_worm_adata
...
def test_tissue_terms_zebrafish(validator_with_worm_adata, tissue_term, error_variable):
    validator = validator_with_worm_adata
