...
import pytest
from fixtures.valid_adatas import validator_with_crab_eating_macaque_adata


# Pass test that crab eating macaque fixture is valid
def test_valid_adata(validator_with_crab_eating_macaque_adata):
	validator = validator_with_crab_eating_macaque_adata
...
def test_other_species_ensembl(validator_with_crab_eating_macaque_adata, other_genes):
	validator = validator_with_crab_eating_macaque_adata
...
def test_descendent_organism_pass(validator_with_crab_eating_macaque_adata, organism_descendent):
	validator = validator_with_crab_eating_macaque_adata
...
def test_descendent_organism_fail(validator_with_crab_eating_macaque_adata, invalid_organism):
	validator = validator_with_crab_eating_macaque_adata
...
def test_invalid_dev(validator_with_crab_eating_macaque_adata, invalid_dev_stage):
	validator = validator_with_crab_eating_macaque_adata
...
def test_invalid_dev_uberon(validator_with_crab_eating_macaque_adata, invalid_uberon_stage, error_wording):
	validator = validator_with_crab_eating_macaque_adata
...
def test_invalid_celltype(validator_with_crab_eating_macaque_adata, invalid_celltype):
	validator = validator_with_crab_eating_macaque_adata
...
def test_invalid_tissue(validator_with_crab_eating_macaque_adata, invalid_tissue):
	validator = validator_with_crab_eating_macaque_adata
