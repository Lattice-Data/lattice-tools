...
def test_uns_zero_length_passes(validator_with_all_adatas, uns_key, empty_value, expected):
...
def test_uns_zero_length_fails(validator_with_all_adatas, uns_key, empty_value, expected):
    validator = validator_with_all_adatas
    validator.adata.uns[uns_key] = empty_value
    validator.validate_adata()
    assert validator.is_valid is expected
...
def test_uns_zero_length_fails_many_errors(validator_with_all_adatas, uns_key, empty_value, expected):
    validator = validator_with_all_adatas
    validator.adata.uns[uns_key] = empty_value
    validator.validate_adata()
    assert validator.is_valid is expected
...
def test_uns_title_bool_none_fails(validator_with_all_adatas, bool_value, expected):
    validator = validator_with_all_adatas
