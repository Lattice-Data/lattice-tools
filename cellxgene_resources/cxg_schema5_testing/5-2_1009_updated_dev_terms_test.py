...
def test_old_dev_terms_should_fail(validator_with_non_spatial_adata, dev_term, organism):
...
def test_new_dev_terms(validator_with_non_spatial_adata, dev_term, organism):
    validator = validator_with_non_spatial_adata
    validator.adata.obs["development_stage_ontology_term_id"] = dev_term
    validator.adata.obs["organism_ontology_term_id"] = organism
