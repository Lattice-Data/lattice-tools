...
https://github.com/chanzuckerberg/single-cell-curation/issues/1219
...
from fixtures.valid_adatas import (
    validator_with_gorilla_adata
)


def test_passes(validator_with_gorilla_adata):
    validator = validator_with_gorilla_adata
...
@pytest.mark.parametrize(
    "genes", ('ENSDARG00000076014','WBGene00000003', 'FBgn0038542', 
        'ENSCJAG00000077381', 'ENSRNOG00000029315', 'ENSPTRG00000026694',
...
def test_different_species_ensembl(validator_with_gorilla_adata,genes):
    validator = validator_with_gorilla_adata
...
@pytest.mark.parametrize(
    "non_descendents", ('NCBITaxon:9593','NCBITaxon:9592','NCBITaxon:1159185')
)

# Should fail, test if non descendent terms of Gorilla gorilla gorilla
def test_not_descendent(validator_with_gorilla_adata, non_descendents):
    validator = validator_with_gorilla_adata
...
def test_death_stage(validator_with_gorilla_adata):
    validator = validator_with_gorilla_adata
...
def test_life_cycle_stage(validator_with_gorilla_adata):
    validator = validator_with_gorilla_adata
    validator.adata.obs['development_stage_ontology_term_id'] = \
...
def test_invalid_stage(validator_with_gorilla_adata, stages):
    validator = validator_with_gorilla_adata
    validator.adata.obs['development_stage_ontology_term_id'] = \
...
def test_invalid_celltype(validator_with_gorilla_adata, ctypes):
    validator = validator_with_gorilla_adata
...
def test_invalid_tissue(validator_with_gorilla_adata, tissues):
    validator = validator_with_gorilla_adata
