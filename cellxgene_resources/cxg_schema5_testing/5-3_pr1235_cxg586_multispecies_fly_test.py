...
def test_cl_forbidden(validator_with_fly_adata, cell_type_term, error_suffix):
...
def test_non_cl_forbidden_for_fly(validator_with_fly_adata, cell_type_term):
    validator = validator_with_fly_adata
    validator.adata.obs["cell_type_ontology_term_id"] = cell_type_term 
    validator.validate_adata()
    assert not validator.is_valid
...
def test_cl_in_tissue_term_for_cell_culture(validator_with_fly_adata, cell_type_term):
    validator = validator_with_fly_adata
...
def test_non_cl_forbidden_for_fly_cell_culture(validator_with_fly_adata, cell_type_term):
    validator = validator_with_fly_adata
    validator.adata.obs["tissue_type"] = "cell culture"
    validator.adata.obs["tissue_ontology_term_id"] = cell_type_term 
    validator.validate_adata()
...
def test_dev_terms_for_fly(validator_with_fly_adata, dev_term, error_variable):
    validator = validator_with_fly_adata
...
def test_tissue_terms_fly(validator_with_fly_adata, tissue_term, error_variable):
    validator = validator_with_fly_adata
