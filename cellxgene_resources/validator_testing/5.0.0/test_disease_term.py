...
def test_disease_ontology_term_id_true(validator_with_adatas, dt_id, expected):
...
def test_disease_ontology_term_false(validator_with_adatas, dt_id, expected):
    validator = validator_with_adatas
    validator.adata.obs['disease_ontology_term_id'] = dt_id
    validator.validate_adata()
    assert validator.is_valid is expected
...
def test_disease_ontology_term_not_valid(validator_with_adatas, dt_id, expected):
    validator = validator_with_adatas
    validator.adata.obs['disease_ontology_term_id'] = dt_id
    validator.validate_adata()
    assert validator.is_valid is expected
