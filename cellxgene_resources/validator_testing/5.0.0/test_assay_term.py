...
def test_assay_ontology_term_id_valid(validator_with_adatas, at_id, expected):
...
def test_assay_ontology_term_id_not_allowed(validator_with_adatas, at_id, expected):
    validator = validator_with_adatas
    validator.adata.obs['assay_ontology_term_id'] = at_id
    validator.validate_adata()
    assert validator.is_valid is expected
...
def test_assay_ontology_term_id_not_valid(validator_with_adatas, at_id, expected):
    validator = validator_with_adatas
    validator.adata.obs['assay_ontology_term_id'] = at_id
    validator.validate_adata()
    assert validator.is_valid is expected
...
def test_assay_ontology_term_id_suspension_warning(validator_with_adatas, at_id, expected):
    validator = validator_with_adatas
    validator.adata.obs['assay_ontology_term_id'] = at_id
    validator.validate_adata()
    assert validator.is_valid is expected
