...
def test_obs_concat_unique_fails(validator_with_adatas, duplicate_col):
...
def test_var_concat_unique_fails(validator_with_adatas, duplicate_col):
    validator = validator_with_adatas
...
def test_obs_rename_unique_fails(validator_with_adatas, duplicate_col, col_rename_dict):
    validator = validator_with_adatas
...
def test_var_rename_unique_fails(duplicate_col, validator_with_adatas, col_rename_dict):
    validator = validator_with_adatas
...
@pytest.mark.parametrize("test_h5ads", H5ADS)
def test_del_raw_var(validator_with_adatas):
    validator = validator_with_adatas
