...
def test_cell_ontology_term_is_valid(validator_with_adatas, cell_type_term, tissue_type, expected):
...
def test_cell_ontology_term_fails_deprecated(validator_with_adatas, cell_type_term, tissue_type, expected):
    validator = validator_with_adatas
    validator.adata.obs['tissue_type'] = tissue_type
    validator.adata.obs['tissue_type'] = validator.adata.obs['tissue_type'].astype('category')
    validator.adata.obs['cell_type_ontology_term_id'] = cell_type_term
...
def test_cell_ontology_term_fails_not_allowed(validator_with_adatas, cell_type_term, tissue_type, expected):
    validator = validator_with_adatas
    validator.adata.obs['tissue_type'] = tissue_type
    validator.adata.obs['tissue_type'] = validator.adata.obs['tissue_type'].astype('category')
    validator.adata.obs['cell_type_ontology_term_id'] = cell_type_term
...
def test_cell_ontology_term_cell_culture_fails(validator_with_adatas, cell_type_term, tissue_type, expected):
    validator = validator_with_adatas
    validator.adata.obs['tissue_type'] = tissue_type
    validator.adata.obs['tissue_type'] = validator.adata.obs['tissue_type'].astype('category')
    validator.adata.obs['tissue_ontology_term_id'] = cell_type_term
...
def test_cell_ontology_term_cell_culture_fails_deprecated(validator_with_adatas, cell_type_term, tissue_type, expected):
    validator = validator_with_adatas
    validator.adata.obs['tissue_type'] = tissue_type
    validator.adata.obs['tissue_type'] = validator.adata.obs['tissue_type'].astype('category')
    validator.adata.obs['tissue_ontology_term_id'] = cell_type_term
...
def test_cell_culture_wrong_mismatched_tissue_ontology_fails(validator_with_adatas, tissue_type, ontology_term, expected):
    validator = validator_with_adatas
    validator.adata.obs['tissue_type'] = tissue_type
    validator.adata.obs['tissue_type'] = validator.adata.obs['tissue_type'].astype('category')
...
def test_tissue_organoid_wrong_mismatched_tissue_ontology_fails(validator_with_adatas, tissue_type, ontology_term, expected):
    validator = validator_with_adatas
    validator.adata.obs['tissue_type'] = tissue_type
    validator.adata.obs['tissue_type'] = validator.adata.obs['tissue_type'].astype('category')
    validator.adata.obs['tissue_ontology_term_id'] = ontology_term
