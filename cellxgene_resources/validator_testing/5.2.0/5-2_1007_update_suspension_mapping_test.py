...
class TestSuspensionMapping:
    ...
    def test_added_mappings(self, validator_with_adatas, assay, suspension):
    ...
    def test_mismatched_mappings(self, validator_with_adatas, assay, suspension):
        validator = validator_with_adatas
        validator.adata.obs["assay_ontology_term_id"] = assay
        validator.adata.obs["suspension_type"] = suspension
        for col in ["assay_ontology_term_id", "suspension_type"]:
    ...
    def test_deleted_mappings(self, validator_with_adatas, assay, suspension):
        validator = validator_with_adatas
        validator.adata.obs["assay_ontology_term_id"] = assay
        validator.adata.obs["suspension_type"] = suspension
        for col in ["assay_ontology_term_id", "suspension_type"]:
