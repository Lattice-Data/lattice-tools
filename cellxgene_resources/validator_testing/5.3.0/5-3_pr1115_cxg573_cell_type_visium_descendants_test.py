...
VISIUM_H5ADS = [f for f in SPATIAL_H5ADS if "visium" in f]
...
class TestCellTypeVisiumDescendants:
    ...
    def test_visium_descendants(self, validator_with_adatas, assay_term, expected):
    ...
    def test_visium_parent_with_error(self, validator_with_adatas):
        validator = validator_with_adatas
    ...
    def test_in_tissue_zero_w_cell_type_partial(self, validator_with_adatas, assay_term):
        validator = validator_with_adatas
    ...
    @pytest.mark.parametrize(*parameters_visiums)
    def test_in_tissue_zero_w_cell_type_full(self, validator_with_adatas, assay_term):
        validator = validator_with_adatas
        random_cell_type = "CL:0001082"
        validator.adata.obs['assay_ontology_term_id'] = assay_term
    ...
    @pytest.mark.parametrize(*parameters_visiums)
    def test_assay_term_string(self, validator_with_adatas, assay_term):
        validator = validator_with_adatas
        validator.adata.obs["assay_ontology_term_id"] = assay_term
